   ...
   if($_SERVER["REQUEST_METHOD"] == "POST")
    {
      ...
      $mypassword = mysqli_real_escape_string($conn,$_POST['password1']); 
       $mypass = mysqli_real_escape_string($conn,$_POST['password2']); 
...
//      $active = $row['active'];
      ...
      if($count == 1) 
      {
      $sql="update request2 set pass= '$mypass' where voter like '".mysql_real_escape_string ($myusername)."' ";mysqli_query($conn,$sql);
